namespace Hydrospanner.Phases.Transformation
{
	...
	public sealed class TransformationHandler : IEventHandler<TransformationItem>
	{
		...
		private bool Transform()
		{
			...
			var messages = this.transformer.Handle(this.item.Body, this.item.Headers, this.item.MessageSequence, live).ToList();
			...
			for (var i = 0; i < this.buffer.Count; i++)
			{
				...
				var messages2 = this.transformer.Handle(this.buffer[i], BlankHeaders, this.item.MessageSequence + 1 + i, live).ToList();
